...
# OVAJ METOD JE BIO LOS ZATO STO SE MORA MENJATI DEPLOYMENT CONFIG FILE

A TO POZIIVA ERROR DA SE DOGODI, MOZE SE NAPRAVITI NEKI TYPO

UMESTO TOGA BILO BI DOBRO DA SE NEKAKO MOZE KUBERNETESU RECI DA UVEK KORISTI NEWEST VERSION OF A GIVEN IMAGE

A NA TOME CE SE BAZIRATI DRUGI METOD ILI NACIN UPDATING-A DEPLOYMENT-A, KOJI CU TI POKAZATI U SLEDECEM BRANCH-U
