...
# KAO PRVO NE ZELIM DA KORISTIM BETA VERZIJU KONFIGURACIJE ,STO SAM RADIO U PROSLOM BRANCH-U; A PORED TOGA PRIMETIO SAM DA IPAK KORISTIM POGRESAN CLUSTER IP SERVICE FOR GETTING ALL POSTS 
...
## SADA BI TREBALO DA JE ONAJ NODE APP KOJI JE U PODU posts MICROSERVICE-A PROMENJEN
...
Content-Length: 43
Content-Type: application/json; charset=utf-8
Date: Tue, 23 Mar 2021 19:13:48 GMT
ETag: W/"2b-qNOYxgpEIRjZtbFGXFVCmuV7hBY"
X-Powered-By: Express

{
    "id": "7dc5445c",
    "title": "Hi I am Stavros"
}

```

## DAKLE TREBA DA SHVATIS DA KADA GLEDAS PATH DA NE POMISLIS DA MOZDA TREBAS DA APPEND-UJES DODATNE STVARI (DODATNE PATH-OVE), SVOG EXPRESS APP-A

TO SAM TI UPRAVO POKAZAO IZ PROLOG PRIMERA

INGRSS CONTROLLER, ODNOSNO UNDERLING NGINX REVERSE PROXY SALJE TRAFFIC NA `/create`

OVO GOVORIM JER MI SE DESILO DA POSMATRAM TAJ PATH SISTEM ODVOJENO ON EXPRESS APP-A, PA DA APPEND-UJEM NESTO NA URL STO NE TREBAM KADA PRAVIM REQUEST

ISTO TAKO TREBAS DA U GLAVI IMAS ZAMISLEN FLOW TTRAFFIC-A

TO CU TI PONOVITI

- CITAV SISTEM OKO INGRESS-A TACNIJE CLOUD PROVIDER, GENERISE LOAD BALANCER-A, KOJI SLAJE TRAFFIC DO INSTATICIZIRANOG INGRESS CONTROLLER-A

- INGRESS CONTROLLER SHODNO KONFIGURACIJI KOJOM SAM NAHRANI CLUSTER, SALJE TRAFFIC DO ONIH CLUSTER IP SERVICE-A, ZA KOJE SAM SPECIFICIRAO PORT-OVE I IMENA

**A TU SE SPECIFICIRA I PATH, A MORAM SE POTARATI DA NA TIM PATH-OVIMA, EXPRESS SERVER LISTEN-UJE FOR REQUESTS**

TO JE DAKLE NAJVAZNIJE

# JA SAM, DO SADA HANDLE-OVAO DIRECTING TRAFFIC-A OD INGRESS CONTROLLER-A DO DVA CLUTER IP SERVISA, KOJI STOJE ISPRED PODS U KOJIMA RUNN-UJU NODE APPS, KOJE SLUZE, JEDNA ZA GETTING ALL POSTS AND COMMENTS, I DRUGA ZA KREIRANJE JEDNOG POST-A

OSTAJE MI JOS DA HANDLE-UJEM TRAFFIC, KOJI CE NA KRAJU DOVESTI DO KREIRANJA SINGLE COMMENT-A, ALI TO JE KOMPLIKOVANIJA STVAR JER JE U PITANJU DYNAMIC PATH KOJ IZAVISI OD REKLATED POST ID-JA

I OSTAJE MI DA DOCKERIZUJEM I KUBERNATEIZUJEM REACT APP
