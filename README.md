...
DA OMOGUCIM REGULAR EXPRESSION, KAKO VIDIS DOLE ZADAO SAM `` UNDER annotations
...
A KAO STO VIDIS DODAO SAM I NOVI PATH, KOJ IFORMIRN SA OSTALI MSTVARIMA USTVARI OMOGUCAVA DA INGRES CONTROLLER SEND-UJE TRAFFIC DO CLUSTER IP SERVICE-A KOJI JE IN FRONT OF POD-A U KOJEM JE CONTAINARIZOVAN NODEJS comments MICROSERVICE
