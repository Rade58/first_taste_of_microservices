...
**U SUTINI TI KADA SALJES REQUEST PREMA `myblog.com` USPESNO JE PREVAREN INGRESS CONTROLLER DA IPAK PRIHVATI TAJ REQUEST IAKO U SUSTINI REQUEST SE SALJE NA TVOJ CLUSTER IP**

AKO SE PITAS ZASTO SVE OVO POMENUTO, SAMO IZCITAJ PROSLI BRANCH
