...
TAKO DA CU MORATI DA DODAM JOS KONFIGURACIJE U INGRESS CONTROLLER CONFIGURATION FILLE

DODACU DEO CONFIG-A, KOJ ICE OMOGUCITI DA SE MOZE KORISTITI REGULAR EXPRESSION ZA PATH MACHINNG

A ONDA CU DA SA REGULAR EXPRESSION-OM DEFINISEM DINAMICKI DEO PATHA, KOJI CU ZADATI, KAO PATH, KOJI CE BITI DEO URL-A ZA CLUSTER IP SERVICE KOJI STOJI ISPRED POD-A U KOJEM JE comments MICROSERVICE
