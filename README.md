...
# 7. POSTO SAM MENJAO GORNJI FILE, MORAM DA REBUILD-UJEM RELATED IMAGE

- `cd event_bus`

- `docker build -t radebajic/event_bus .`

# 8. MORAM DA PUSH-UJEM GORNJI UPDATED IMAGE TO DOCKER HUB

- `docker push radebajic/event_bus`

# 9. MORAM DA PULL-UJEM IMAGE SA DOCKERHUB-A KAKO BI GA ISKORISTIO ZA REBUILDING DEPLOYMENTA, RELATED TO EVENT BUS
...
MOZDA CES MORATI DA EDITUJES FILES, KAKO BI STMAPO EVENT-OVE TAMO GDE SE NTICIPATE-UJU

JA SAM TO OVERLOOOK-OVAO, PA SAM RANIJ BRISAO CONSOE LOGS, I MRZI ME DA SE SADA VRACAM DA TO RADIM

UGLAVNOM TI MZOES MENJATI CODEBASE I OD TOG STEPA OBAVITI CEO PROCES KAKO BI TESTIRAO, OVAKO KAKO SAM TI POKAZAO
